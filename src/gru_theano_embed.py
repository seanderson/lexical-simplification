...
class GRUTheano:
    ...
    def __init__(self, word_dim, hidden_dim=10, output_dim=1, bptt_truncate=-1,wordEmbed=None):
        ...
        vocab = wordEmbed # all vocab vectors
        ...
        self.vocab = theano.shared(name='vocab', value=vocab.astype(theano.config.floatX))
    ...
    def __theano_build__(self):
        ...
        vocab = self.vocab # DBG added 6/16
